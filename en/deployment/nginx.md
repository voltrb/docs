...
If you want to run volt directly, we recomend you run behind Nginx.  You can setup Nginx to serve static assets (using [bundle exec volt precompile](deployment/README.md))  The following nginx.conf file can be used: (also, don't forget to include a mime.types file, see below)
...
The following mime.types is updated to support some newer font formats.
